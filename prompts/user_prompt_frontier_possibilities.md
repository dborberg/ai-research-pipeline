...
- Describe new capabilities, new interaction models, new product architectures, new operating models, and new forms of human-machine collaboration that could become possible because Gen AI exists.
- Avoid making the report primarily about stocks, valuation, margins, market share, public-market beneficiaries, or investment recommendations.
...
- how work inside the sector changes
- how products and platforms change
- how customer experiences change
- how infrastructure behaves differently
- how software, hardware, networks, security, logistics, physical systems, or devices become more adaptive, where relevant
- what new categories of tools, interfaces, operating layers, or services may emerge
...
3. What does the AI connect to, observe, generate, simulate, coordinate, or control?
...
5. Most Frontier Ideas Worth Watching
6. Frontier Scenario: A Day in the Life
7. Reality Check
...
- Do not frame the summary around winners, losers, margins, valuation, stock-market relevance, or investable signals.
...
- Where relevant, the scenario may include:
  - an executive or manager using an AI operating layer
  - a customer or end user interacting with an adaptive product or service
  - a technical expert approving AI-generated options
  - infrastructure or systems explaining their own status
  - security, compliance, or risk controls shaping what the AI can do
  - multiple teams working from a shared AI-generated view of reality
- The story should show:
  - what the human or team is trying to accomplish
  - how the AI assists
  - what systems, data, tools, devices, or workflows the AI connects to
...
- Include:
  ...
  - cybersecurity or privacy requirements
...
- Make speculative scenarios clearly speculative.
- Do not fabricate current products, partnerships, financial figures, adoption statistics, or regulatory claims.
- Do not imply speculative scenarios are already happening at scale unless the input explicitly supports that.
- If a scenario is speculative, make that clear.
- Do not cite companies unless they are provided in the input or are necessary as general context.
...
For broad sector-level reports, confirm that at least two use cases are customer-facing, user-facing, product-facing, or infrastructure-facing rather than only internal productivity workflows.
