...
- If FRONTIER_CAPITAL_MARKETS_OVERRIDE is YES, evaluate the story for TOP STORIES, CAPITAL MARKETS AND INVESTMENT IMPLICATIONS, WHAT TO WATCH, or ADVISOR / WHOLESALER SOUNDBITES. Do not create a standalone Frontier Technology Capital Markets section.
- Do not omit a major frontier technology capital markets event merely because the article does not contain narrow Gen AI keywords. If the company is AI-adjacent rather than pure Gen AI, explain that honestly with language such as: This is not a pure Gen AI story, but it matters for the broader innovation cycle because...
- For SpaceX IPO-style stories, explain the connection to public-market appetite for mega-cap frontier technology, satellite communications, defense, autonomy, edge connectivity, strategic infrastructure, private-market liquidity, or the broader innovation cycle. Do not force a narrow AI link.
...
- If any article is marked FRONTIER_CAPITAL_MARKETS_OVERRIDE: YES, evaluate it for TOP STORIES or CAPITAL MARKETS AND INVESTMENT IMPLICATIONS before excluding it. If it is mainly a forward-looking signal, use WHAT TO WATCH or ADVISOR / WHOLESALER SOUNDBITES.
