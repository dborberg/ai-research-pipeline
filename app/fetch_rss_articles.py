...
FEED_BUCKETS = {
    ...
    "enterprise_labor": [
        ...
        "https://news.google.com/rss/search?q=site:servicenow.com+AI+workflow+enterprise",
        "https://news.google.com/rss/search?q=site:salesforce.com+AI+agent+enterprise",
        "https://news.google.com/rss/search?q=site:snowflake.com+AI+data+cloud+enterprise",
        "https://news.google.com/rss/search?q=site:datadoghq.com+AI+observability+enterprise",
        "https://news.google.com/rss/search?q=site:crowdstrike.com+AI+security+enterprise",
        "https://news.google.com/rss/search?q=site:paloaltonetworks.com+AI+security+platform",
    ],
    "policy_regulation": [
        ...
        "https://www.federalregister.gov/documents/search.rss?conditions%5Bterm%5D=artificial+intelligence",
        "https://www.nist.gov/news-events/news/rss.xml",
        "https://www.ftc.gov/news-events/news/press-releases/rss",
        "https://news.google.com/rss/search?q=site:justice.gov+AI+policy+OR+AI+regulation",
        "https://news.google.com/rss/search?q=site:europa.eu+AI+Act+OR+artificial+intelligence+regulation",
    ],
